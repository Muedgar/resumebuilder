...
const Introduction = () => {
    ...
    return (
        ...
        <div className="templatetwointroduction">
            
            <div className="templatetwointroduction-title">
                <img className="templatetwoquoteIcon" src={person} alt="edit intro" />
                <h1>Profile</h1>
            </div>
            {editStatus? 
            ...
            setEditStatus(true);
        }} className="templatetwomenu" alt="introsave" />
                <textarea placeholder="Write about yourself" id="introTextArea" defaultValue={editIntro} className="templatetwo" onChange={e => {
