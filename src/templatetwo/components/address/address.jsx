...
const Address = () => {
    ...
    return (
        ...
        <div className="templatetwoaddress">
            <div className="templatetwointroduction-title">
                <h1>Details</h1>
            </div>
            {editStatus? 
            <>
            <img src={save} className="templatetwomenu" alt="addresssave" onClick={() => {
                setEditStatus(false);
            }} />
            <div className="templatetwoaddressEditContainer">
            <div>
            ...
            <div className="templatetwoaddressContainer">
                <div>
                    <img src={homeIcon} alt="homeIcon" />
