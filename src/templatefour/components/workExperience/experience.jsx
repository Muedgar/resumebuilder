    ...
    return (
        <div className="experienceContainer">
            <div className="control">
                {jobTitleStatus?
                <>
                <p className="experienceTitle">{jobTitle}</p>
                <img className="imgLi icon" src={edit} alt="edit" aria-hidden="true" onClick={e=> {
                ...
                <img className="imgLi icon" src={save} alt="edit" aria-hidden="true" onClick={e=> {
                    setJobTitleStatus(!jobTitleStatus);
                }} />
                </>
                }
            ...
            {jobDurationStatus?
            <>
            <p className="experienceYear">{jobDuration}</p>
            <img className="imgLi icon" src={edit} alt="edit" aria-hidden="true" onClick={e=> {
            ...
            <div className="control">
                {jobTitleStatus2?<p className="experienceTitle">{jobTitle2}</p>:<input value={jobTitle2} onChange={e=>setJobTitle2(e.target.value)}/>}
                <img className="imgLi icon" src={edit} alt="edit" aria-hidden="true" onClick={e=> {
                    setJobTitleStatus2(!jobTitleStatus2);
                }} />
            </div>
            <div className="control" style={{marginTop: '-1em'}}>
            {jobDurationStatus2?<p className="experienceYear">{jobDuration2}</p>:<input value={jobDuration2} onChange={e=>setJobDuration2(e.target.value)}/>}
                <img className="imgLi icon" src={edit} alt="edit" aria-hidden="true" onClick={e=> {
