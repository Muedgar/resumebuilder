    ...
    */
    ...
    return (
        <div className="fourTemplateexperienceContainer">
            ...
            <div className="fourTemplatecontrol" style={{marginTop: '-1em'}}>
            {jobDurationStatus?
            <>
            <p className="fourTemplateexperienceYear">{jobDuration}</p>
            <img className="fourTemplateimgLi fourTemplateicon" src={edit} alt="edit" aria-hidden="true" onClick={e=> {
            ...
            <div className="fourTemplatecontrol" style={{marginTop: '-1em'}}>
            {jobDurationStatus2?<p className="fourTemplateexperienceYear">{jobDuration2}</p>:<input value={jobDuration2} onChange={e=>setJobDuration2(e.target.value)}/>}
                <img className="fourTemplateimgLi fourTemplateicon" src={edit} alt="edit" aria-hidden="true" onClick={e=> {
