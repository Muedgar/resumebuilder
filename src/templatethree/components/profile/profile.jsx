...
const Profile = () => {
    ...
    return(
        <div className="threeTemplateProfile">
            <div id="profileImage" className="threeTemplateprofileContainer">
            ...
            {editStatus? 
            <>
            <img src={save} className="threeTemplatemenu" alt="addresssave" onClick={() => {
                setEditStatus(false);
            }} />
            <div className="threeTemplateprofileEditContainer">
                <div>
                    <input className="threeTemplateform-control" value={userName} onChange={event=>setUserName(event.target.value)}/>
                </div>
                <div>
            ...
            :
            <>
            <img className="threeTemplatemenu" onClick={()=>{
            setEditStatus(true);
            ...
            <div className="threeTemplateprofileContainerInfo">
                <div>
                    <h4><span className="threeTemplatefirstName">{getNames()[0]}</span> <span className="threeTemplateLastName">{getNames()[1]}</span></h4>
                </div>
                <div>
