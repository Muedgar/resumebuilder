...
const Introduction = () => {
    ...
    return (
        ...
        <div className="threeTemplateintroduction">
            
            <div className="threeTemplateintroduction-title">
                <img className="threeTemplatequoteIcon" src={person} alt="edit intro" />
                <h1>Profile</h1>
            </div>
            {editStatus? 
            ...
            setEditStatus(true);
        }} className="threeTemplatemenu" alt="introsave" />
                <textarea placeholder="Write about yourself" id="introTextArea" defaultValue={editIntro} className="threeTemplate" onChange={e => {
